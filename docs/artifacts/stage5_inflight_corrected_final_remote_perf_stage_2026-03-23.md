...
- local raw: `docs/artifacts/stage5_inflight_corrected_final_remote_perf_stage_2026-03-23.local.jsonl`
- client stage trace: `docs/artifacts/stage5_inflight_corrected_final_remote_perf_stage_2026-03-23.client.jsonl`
- exit stage trace: `docs/artifacts/stage5_inflight_corrected_final_remote_perf_stage_2026-03-23.exit.jsonl`
- direct forward stage trace: `docs/artifacts/stage5_inflight_corrected_final_remote_perf_stage_2026-03-23.direct.jsonl`
- joined per-run view: `docs/artifacts/stage5_inflight_corrected_final_remote_perf_stage_2026-03-23.joined.jsonl`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| direct | 0 | - | - | - | - | - | - | - | - | - | 1291.77 | - | - | - | - | - | - | - | - | - | - | - |
| remote-1hop | 1 | 4543.34 | 454.00 | 1.00 | 0.40 | 0.20 | 1705.55 | 201.60 | 0.00 | 1511.80 | 1708.77 | 0.0909 | 244.00 | 397.60 | 4 | 4.00 | 1103.40 | 275 | 64 | 0 | 0 | 64 |
| remote-2hop | 2 | 1869.93 | 371.00 | 0.60 | 0.00 | 0.00 | 1182.71 | 54.80 | 0.00 | 997.00 | 1185.07 | 0.0000 | 185.60 | 203.60 | 4 | 3.00 | 741.60 | 269 | 64 | 0 | 0 | 64 |
| remote-3hop | 3 | 2539.75 | 490.00 | 0.80 | 0.00 | 0.00 | 1420.07 | 41.40 | 0.00 | 1210.00 | 1422.69 | 0.0000 | 239.20 | 251.80 | 4 | 4.00 | 962.20 | 274 | 64 | 0 | 0 | 64 |

## Bottleneck Ranking

1. Warm route ready (one-time): `2984.34 ms`
2. Overlay pre-first-byte gap: `1436.17 ms`
3. Overlay first-send -> client first-byte gap: `1436.11 ms`
4. Exit/body delivery tail: `1239.60 ms`
5. Handshake/session setup (one-time): `438.33 ms`
6. Window/backpressure stall: `99.27 ms`
7. Route selection overhead: `3.33 ms`
8. Client body completion tail: `1.74 ms`
9. Target connect: `0.80 ms`
10. Target first-byte wait: `0.13 ms`
...
- `total_time_ms` vs `ack_latency_ms_avg`: `0.888`

## Findings

- The best overlay path in this sample is `remote-2hop` with avg total `1185.07 ms`.

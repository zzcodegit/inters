...
- avg TTFB ms: 270.57
- avg total ms: 275.60
- avg throughput Bps: 122806.42

### adaptive

- runs: 5
- avg connect ms: 15.28
- avg TTFB ms: 285.79
- avg total ms: 301.25
- avg throughput Bps: 112726.88
...
- pacing: enabled
- congestion states: nonex5
- avg ack avg ms: 72.40
- avg ack p95 ms: 105.40
- avg total retransmits: 10.40
- avg retransmit rate: 0.2737
- avg retransmit ppm: n/a
- avg hard window wait ms: 0.00
- avg effective cap wait ms: 0.00
- avg pacing delay ms: 27.40
- avg pacing interval ms: 1.00
- avg burst prevented: 2.20
- avg paced batches: 3.20
- avg max send burst frames: 29.60
- avg effective inflight cap: 64.00
- avg inflight cap reduced count: 0.00
- avg inflight cap restore count: 0.00
- avg ack pressure events: 0.00
